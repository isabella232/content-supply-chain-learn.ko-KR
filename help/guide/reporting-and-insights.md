...
description: 비즈니스 지표에 맞게 전체 고객 여정에서 컨텐츠 성능을 측정합니다.
...
비즈니스 지표에 맞게 전체 고객 여정에서 컨텐츠 성능을 측정합니다.
...
<table>
    <tr style="border: 0;">
      ...
      <td style="align: center">
        <p style="margin: 0"><img alt="분석" src="/help/assets/analytics-logo.png" style="width: 42px;height:42px;"></p>
        <strong>분석</strong>
      </td>
    </tr>
</table>
