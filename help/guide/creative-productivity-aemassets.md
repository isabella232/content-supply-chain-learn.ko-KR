...
description: 락스타의 창조성을 가진 회사를 위해 그러나 그것은 생산을 향상시켜야 합니다. Adobe 콘텐츠 공급망은 GenAI로 대체된 도구를 제공하여 콘텐츠 제작, 전달 및 검색 기능을 향상시킵니다.
...
록스타 크리에이티브를 가지고 있지만 콘텐츠 제작을 활성화해야 하는 기업을 위해. Adobe 콘텐츠 공급망은 GenAI로 대체된 도구를 제공하여 콘텐츠 제작, 전달 및 검색 기능을 향상시킵니다.
    ...
    <tr>
      <td style="width:33%">
        <a href="https://experienceleague.adobe.com/docs/courses/using/ExperienceManager-A-1-2020.1.aem" target="_blank">
          <img alt="Experience Manager에 대한 관리 액세스 구성" src="https://cdn.experienceleague.adobe.com/thumb/configure-access-to-aem-for-administrators.jpg">
        </a>
        <div>
          <a href="https://experienceleague.adobe.com/docs/courses/using/ExperienceManager-A-1-2020.1.aem" target="_blank">
...
<div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Creative Cloud and Assets Essentials" tabIndex="8">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>Assets Essentials을 Adobe Creative Cloud Libraries와 통합하는 방법에 대해 알아봅니다.</em></p>
      </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/aem-desktop-app.html" title="AEM 데스크탑 앱 사용" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/28868?format=jpeg" alt="AEM 데스크탑 앱 사용">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
    ...
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/content-fragments-console/overview.html" title="콘텐츠 조각 콘솔 비디오" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3419311?format=jpeg" alt="콘텐츠 조각 콘솔 비디오">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    ...
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          ...
          <p class="is-size-6"><em>사이트 편집기의 UI를 사용하여 Adobe Experience Manager Sites에서 페이지를 작성하는 방법을 알아봅니다.</em></p>
      </div>
